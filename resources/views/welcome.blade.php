                    ...
                    <div class="row mb-5 mb-xl-8 g-5 g-xl-8">
                        ...
                        <div class="col-6">
                            ...
                            <a class="card flex-column justfiy-content-start align-items-start text-start w-100 text-gray-800 text-hover-primary p-10"
                                ...
                                <i class="ki-duotone ki-fingerprint-scanning fs-2tx mb-5 ms-n1 text-gray-500"><span
                                        class="path1"></span><span class="path2"></span><span class="path3"></span><span
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select class="form-select form-select-solid" multiple
                                                    ...
                                                    data-dropdown-parent="#kt_menu_6734d7445f4c5" data-allow-clear="true">
                                                    <option></option>
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="card card-xl-stretch mb-xl-8">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <!--begin::Chart-->
                                    <div class="mixed-widget-5-chart card-rounded-top" data-kt-chart-color="primary"
                                    ...
                                    <div class="mt-5">
                                            ...
                                            <div class="d-flex align-items-center me-2">
                                                ...
                                                <div class="symbol symbol-50px me-3">
                                                    <div class="symbol-label bg-light">
                                                        <img src="assets/media/svg/brand-logos/plurk.svg" alt=""
                                                            class="h-50" alt="" />
                                                    </div>
                                                </div>
                                                <!--end::Symbol-->
                                        ...
                                        <div class="d-flex flex-stack mb-5">
                                            ...
                                            <div class="d-flex align-items-center me-2">
                                                ...
                                                <div class="symbol symbol-50px me-3">
                                                    <div class="symbol-label bg-light">
                                                        <img src="assets/media/svg/brand-logos/figma-1.svg" alt=""
                                                            class="h-50" alt="" />
                                                    </div>
                                                </div>
                                                <!--end::Symbol-->
                                        ...
                                        <div class="d-flex flex-stack">
                                            ...
                                            <div class="d-flex align-items-center me-2">
                                                ...
                                                <div class="symbol symbol-50px me-3">
                                                    <div class="symbol-label bg-light">
                                                        <img src="assets/media/svg/brand-logos/vimeo.svg" alt=""
                                                            class="h-50" alt="" />
                                                    </div>
                                                </div>
                                                <!--end::Symbol-->
